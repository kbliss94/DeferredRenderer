...
{
	//assuming both meshes have the same material & that the name is irrelevant

	mData.Vertices.insert(mData.Vertices.end(), rhs.mData.Vertices.begin(), rhs.mData.Vertices.end());
	mData.Normals.insert(mData.Normals.end(), rhs.mData.Normals.begin(), rhs.mData.Normals.end());
	mData.Tangents.insert(mData.Tangents.end(), rhs.mData.Tangents.begin(), rhs.mData.Tangents.end());
	mData.BiNormals.insert(mData.BiNormals.end(), rhs.mData.BiNormals.begin(), rhs.mData.BiNormals.end());
	mData.TextureCoordinates.insert(mData.TextureCoordinates.end(), rhs.mData.TextureCoordinates.begin(), rhs.mData.TextureCoordinates.end());
	mData.VertexColors.insert(mData.VertexColors.end(), rhs.mData.VertexColors.begin(), rhs.mData.VertexColors.end());
	mData.FaceCount += rhs.mData.FaceCount;
	mData.Indices.insert(mData.Indices.end(), rhs.mData.Indices.begin(), rhs.mData.Indices.end());
...
Mesh& Mesh::operator=(const Mesh& rhs)
{
	mData.Vertices = rhs.mData.Vertices;
	mData.Normals = rhs.mData.Normals;
	mData.Tangents = rhs.mData.Tangents;
	mData.BiNormals = rhs.mData.BiNormals;
	mData.TextureCoordinates = rhs.mData.TextureCoordinates;
	mData.VertexColors = rhs.mData.VertexColors;
	mData.FaceCount = rhs.mData.FaceCount;
	mData.Indices = rhs.mData.Indices;
